...
urlpatterns = [
    ...
    url(r'^back_end/lugares/(\d+)/sectores', include('back_end.sectores.urls')),
    url(r'^back_end/lugares', include('back_end.lugares.urls')),
    url(r'^back_end/asientos', include('back_end.asientos.urls')),
    url(r'^back_end/eventos/(\d+)/preciosentradas', include('back_end.preciosentradas.urls')),
    url(r'^back_end/eventos/(\d+)/entradas', include('back_end.entradas.urls')),
